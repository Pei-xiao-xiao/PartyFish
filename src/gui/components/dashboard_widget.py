...
class DashboardWidget(QWidget):
    ...
    def _create_dashboard_link_icon(self, icon_kind: str, color: str = "#06b6d4") -> QIcon:
        """创建链接图标"""
    ...
    def _create_dashboard_link_button(self, text: str, icon_kind: str, handler) -> QPushButton:
        """创建链接按钮"""
    ...
    def update_pokedex_progress(self, collected: int, total: int, collected_q: int, total_q: int):
        """更新图鉴进度"""
    ...
    def apply_theme(self):
        ...
        self.sales_progress_bar.setStyleSheet(f"""
            QWidget {{
        ...
        self.pokedex_divider_line.setStyleSheet(f"background-color: {divider_color}; border: none;")
