...
class FishPreviewWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        current_mode = cfg.get_global_setting("fish_filter_mode", "all")
        ...
        current_rod_mode = cfg.get_global_setting("rod_filter_mode", "all")
    ...
    def _on_fish_filter_changed(self, routeKey: str):
        """处理鱼种过滤改变"""
        cfg.set_global_setting("fish_filter_mode", routeKey)
        cfg.save()
    ...
    def _on_rod_filter_changed(self, routeKey: str):
        """处理竿类型过滤改变"""
        cfg.set_global_setting("rod_filter_mode", routeKey)
        cfg.save()
        self._refresh_fish_preview()
        self.filter_changed.emit()
    ...
    def _refresh_fish_preview(self):
        ...
        try:
            ...
            filter_mode = cfg.get_global_setting("fish_filter_mode", "all")
            if filter_mode == "lure":
                catchable_fish = [
            ...
            rod_filter_mode = cfg.get_global_setting("rod_filter_mode", "all")
