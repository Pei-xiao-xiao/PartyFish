...
class FishPreviewItem(QWidget):
    ...
    def __init__(self, fish_name, image_path, location_icon_path=None, parent=None):
        ...
        if image_path and os.path.exists(image_path):
            ...
            loc_pixmap = QPixmap(location_icon_path) if location_icon_path and os.path.exists(location_icon_path) else None
    ...
    def _process_icon(self, pixmap, size, location_pixmap=None):
        ...
        if location_pixmap:
            ...
            scaled_loc = location_pixmap.scaled(loc_size, loc_size, Qt.KeepAspectRatio, Qt.SmoothTransformation)
