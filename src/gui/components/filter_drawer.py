...
from PySide6.QtCore import Qt, QPropertyAnimation, QPoint, QEasingCurve, Signal, QRect, QEvent
...
class FilterDrawer(QWidget):
    ...
    def _adjust_geometry(self):
        ...
        # 自身覆盖在标题栏下方区域
        self.setGeometry(0, h_offset, self.parent_widget.width(), self.parent_widget.height() - h_offset)
