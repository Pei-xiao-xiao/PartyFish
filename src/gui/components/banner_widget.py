...
class BannerWidget(QWidget):
    ...
    def _setup_controls(self):
        ...
        self.control_grid.addWidget(self.overlay_label, 0, 0, Qt.AlignRight | Qt.AlignVCenter)
        ...
        self.control_grid.addWidget(self.account_label, 0, 2, Qt.AlignRight | Qt.AlignVCenter)
        ...
        self.sound_switch.setChecked(cfg.global_settings.get("control_sound_enabled", False))
        self.sound_switch.checkedChanged.connect(self.sound_toggled.emit)
        self.control_grid.addWidget(self.sound_label, 1, 0, Qt.AlignRight | Qt.AlignVCenter)
        ...
        self.control_grid.addWidget(self.preset_label, 1, 2, Qt.AlignRight | Qt.AlignVCenter)
        ...
        self.release_mode_segment.currentItemChanged.connect(self.release_mode_changed.emit)
        self.control_grid.addWidget(self.release_mode_label, 2, 0, Qt.AlignRight | Qt.AlignVCenter)
        ...
        self.screenshot_mode_segment.currentItemChanged.connect(self.screenshot_mode_changed.emit)
        self.control_grid.addWidget(self.screenshot_mode_label, 2, 2, Qt.AlignRight | Qt.AlignVCenter)
    ...
    def refresh_account_controls(self):
        ...
        self.release_mode_segment.blockSignals(True)
        self.release_mode_segment.setCurrentItem(cfg.global_settings.get("release_mode", "off"))
        self.release_mode_segment.blockSignals(False)
        ...
        self.screenshot_mode_segment.blockSignals(True)
        self.screenshot_mode_segment.setCurrentItem(cfg.global_settings.get("screenshot_mode", "wegame"))
        self.screenshot_mode_segment.blockSignals(False)
